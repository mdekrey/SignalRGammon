...
namespace SignalRGame.Logging
{
    internal class OpenTracingLogger : ILogger
    {
        ...
        private readonly OpenTracingLoggerProvider parent;
        private readonly ITracer _tracer;
        private readonly string _categoryName;

        public OpenTracingLogger(OpenTracingLoggerProvider parent, ITracer tracer, string categoryName)
        {
            this.parent = parent;
            _tracer = tracer;
        ...
        {
            return parent.BeginScope(state?.ToString() ?? "unknown");
        }
