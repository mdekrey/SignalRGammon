...
namespace SignalRGame.ClashOfClones.StateComponents
{
    ...
    public static class ArmyLayoutExtensions
    {
        public static bool IsEmpty(this ArmyLayout layout, int column, int row) =>
            layout[column, row] is EmptyPlaceholder;

        public static ArmyLayout Drop(this ArmyLayout layout, int column, UnitInstance unit) =>
            ClashOfClones.Rules.DropLogic.Drop(layout, column, unit);
    }
}
